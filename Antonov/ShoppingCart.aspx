<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Antonov.ShoppingCart" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ShoppingCartTitle" runat="server" 
class="ContentHead"><h1>Корзина</h1></div>
...
ShowFooter="True" GridLines="Vertical" CellPadding="4"
        ItemType="Antonov.Models.CartItem" SelectMethod="GetShoppingCartItems" 
...
Convert.ToDouble(Item.Product.UnitPrice)))%>
    ...
    <tr>
      <td>
        <asp:Button ID="UpdateBtn" runat="server" Text="Обновить" 
